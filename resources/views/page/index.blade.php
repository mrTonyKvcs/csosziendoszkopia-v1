				...
				<div class="flex">
					...
					<div class="flex-1 ml-3 md:flex md:justify-between">
						<p class="text-lg text-blue-700"><strong>Kedves Betegünk!</strong> <br><br> Elsődlegesen online bejelentkezéssel tudunk beteget fogadni.
                            Amennyiben kérdése van, illetve segítségre van szüksége a foglalással kapcsolatban, jelezze felénk email vagy telefonos elérhetőségünkön.<br><br> Vastagbéltükrözésre esetleges polyp eltávolítást csak friss (1 héten belüli) laboreredménnyel (teljes vérkép, INR, APTT)  tudjuk elvégezni.</p>
					</div>
				</div>
			</div>
<div class="p-4 mt-4 rounded-md bg-blue-50">
