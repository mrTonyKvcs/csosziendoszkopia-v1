<div
    x-data="{open: @entangle('select'), active: @entangle('type')}"
>
	<label for="first-name" class="block mt-5 text-lg font-medium text-gray-700">Oldal választás</label>
    <div class="relative mt-1">
        ...
        <ul
            ...
            @foreach($this->types as $type)
                <li
						wire:click="setActiveType({{ $type->id }})"
